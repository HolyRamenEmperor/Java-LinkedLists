...
public class ListLab1
{
   ...
   public static ListNode copyList(ListNode arg)
   {
      ...
      {
         ListNode head2 = new ListNode(arg.getValue(), arg.getNext());
   ...
   public static ListNode rest(ListNode h)
   {
      if(h.getNext() == null)
      {
         ListNode copy = new ListNode(h.getValue(), null);
         return copy; 
      }
      else
      {
         ListNode head = new ListNode(h.getValue(), h.getNext());
         rest(head.getNext());
         return head.getNext();
      }
   ...
   {
      if(head.getValue() == null || head.getNext() == null)
      {
         return null;
      }
      else
   ...
   {
      ListNode a = new ListNode(head.getValue(), head.getNext());
      while(a.getNext() != null)
      {  
         a = a.getNext();
      }
      a.setNext(new ListNode(arg, null));
